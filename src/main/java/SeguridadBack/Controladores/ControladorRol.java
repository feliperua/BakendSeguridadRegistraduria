...
public class ControladorRol {
    ...
    public Rol show(@PathVariable String id){
        ...
        if(rolActual==null)
        {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"El rol no fue ecnontrado");
        }
        return rolActual;
    ...
    public Rol update(@PathVariable String id,@RequestBody  Rol infoRol){
        ...
        if(rolActual==null)
        {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"El rol no fue encontrado");
        }
        if (rolActual!=null){
